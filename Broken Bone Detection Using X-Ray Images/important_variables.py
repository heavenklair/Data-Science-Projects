...
model_path_unet = 'saved_models/fracture_segmentation_unet_model.hdf5'
model_path_encoder_decoder = 'saved_models/fracture_detection_encoder_decoder_model.hdf5'
